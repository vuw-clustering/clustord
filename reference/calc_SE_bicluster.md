...
[`clustord`](https://vuw-clustering.github.io/clustord/reference/clustord.md),
which includes the component `out_parvec`, the final vector of
independent parameter values from the EM algorithm, which will
correspond to a subset of the parameter values in `out_parlist`.
