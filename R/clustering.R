...
#' Row clustering using Ordered Stereotype Models (OSM) or Proportional Odds Models (POM) or Binary Models.
#'
...
#' Note that the alpha, beta and gamma coefficients have negative signs. This is
#' so that as the row cluster index increases, or as the column index increases,
#' Y is more likely to fall at higher values (see Ch4 of Agresti's book
#' "Analysis of Ordinal Categorical Data" 2010).
#' For Binary -- model = "Binary":
#' Y~row: Logit=mu+alpha_r
#' Y~row+column: Logit=mu+alpha_r+beta_j
#' Y~row+column+row:column, or Y~row*column: Logit=mu+alpha_r+beta_j+gamma_rj
...
#' @param model: "OSM" for Ordered Stereotype Model or "POM" for Proportional
#'     Odds Model or "Binary for binary data model.
...
#'     For Binary,
#'     use the same starting values as for POM but only 1 component for mu.
...
#' Column clustering using Ordered Stereotype Models (OSM) or Proportional Odds Models (POM) or Binary Models.
#'
#' Users need to enter their chosen formula and model:
#' For Ordered Stereotype -- model = "OSM":
...
#' Biclustering using Ordered Stereotype Models (OSM) or Proportional Odds Models (POM) or Binary Models.
#'
#' Users need to enter their chosen formula and model:
#' For Ordered Stereotype -- model = "OSM":
